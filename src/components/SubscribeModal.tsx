    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <motion.div
              className="relative w-full max-w-sm bg-[var(--bg-secondary)] border border-[var(--border-secondary)] rounded-none p-6 shadow-xl"
            ...
            >
              ...
              <div className="text-center">
                ...
                <div className="flex justify-center mb-4">
                  <div className="w-20 h-20 rounded-none overflow-hidden bg-[var(--bg-tertiary)] border border-[var(--border-secondary)] flex items-center justify-center">
                    <svg
                  ...
                  >
                    ...
                    <div className="flex justify-center mb-2">
                      <motion.div
                        ...
                        className="w-12 h-12 rounded-none bg-[var(--bg-brand-solid)]/10 flex items-center justify-center"
                      >
